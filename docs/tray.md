...
- **Search popover** with hybrid / keyword / semantic chips, folder + date filters, inline message-body preview, and one-click "Open in webmail" (Fastmail / Gmail, autodetected from your IMAP host).
