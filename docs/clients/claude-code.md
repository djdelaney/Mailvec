...
- **No auth, 127.0.0.1 only.** Anything running as your user on the same machine can call any tool. That's the threat model — see `mailvec-project-scope.md` §11 for the cloud-access framing.
