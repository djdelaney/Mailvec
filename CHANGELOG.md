...
Groundwork for moving every mail-content parser into a data-less `parse` container ([`docs/proposals/attachment-parser-isolation.md`](docs/proposals/attachment-parser-isolation.md)). Behaviour is unchanged; the project boundaries are not.
